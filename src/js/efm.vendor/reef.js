/*! Reef v7.4.0 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/reef | A lightweight library for creating reactive, state-based components and UI */
var Reef = (function () {
	'use strict';
